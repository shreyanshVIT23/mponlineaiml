...
The main project content is divided into 2 directories:

  ### Project

    Contains the mandatory assignments given by Sir during lecture 

  ### Daily Assignments

    Contains the daily assignments given in the Lecture notes provided by Sir
